#ifndef CS248_RAYTRACER_H
#define CS248_RAYTRACER_H
...
using CS248::StaticScene::EnvironmentLight;

using CS248::StaticScene::BVHNode;
using CS248::StaticScene::BVHAccel;
