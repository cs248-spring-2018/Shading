#ifndef CS248_COLLADA_COLLADA_H
#define CS248_COLLADA_COLLADA_H
...
class ColladaParser {
 ...
 private:
  ...
  static bool parse_objmesh(ifstream& in, PolymeshInfo& polymesh);
  static bool parse_mtl(ifstream& in, PolymeshInfo& polymesh);
